    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center p-8 bg-white rounded-xl shadow-sm border border-red-200 max-w-md">
          ...
          <p className="text-gray-600">You don't have permission to access the Staff dashboard.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:block text-right">
                <p className="text-sm font-medium text-textPrimary">{"Staff"}</p>
                <p className="text-xs text-gray-500">Staff Board</p>
              </div>
